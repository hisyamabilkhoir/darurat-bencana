                    ...
                    <form id="reportForm" enctype="multipart/form-data">
                        ...
                        <div class="form-floating-custom mb-4">
                            ...
                            <input type="text" class="form-control glass-input" id="nama_pelapor" name="nama_pelapor"
                                placeholder="Masukkan nama lengkap Anda" required minlength="1" maxlength="255">
                        ...
                        <div class="form-floating-custom mb-4">
                            ...
                            <input type="text" class="form-control glass-input" id="lokasi" name="lokasi"
                                placeholder="Masukkan lokasi detail kejadian" required minlength="1" maxlength="255">
                        ...
                        <div class="form-floating-custom mb-4">
                            ...
                            <textarea class="form-control glass-input" id="deskripsi" name="deskripsi" rows="5"
                                placeholder="Jelaskan kondisi bencana secara detail..." required
                        ...
                        <div class="form-floating-custom mb-4">
                            ...
                            <div class="upload-area" id="uploadArea">
                                ...
                                <div class="upload-placeholder" id="uploadPlaceholder">
                                    ...
                                    <small class="text-muted">JPG, PNG, WebP (maks. 10MB)</small>
                                </div>
                        ...
                        <div class="form-floating-custom mb-4">
                            <div class="auto-date glass-card-inner">
                                ...
                                <span>Tanggal Laporan: <strong id="currentDate"><?= date('d M Y, H:i') ?>
                                        WIB</strong></span>
                            </div>
                        </div>
